...
func (m *MockFeatureFlagProcessor) IsReady() bool {
	m.ctrl.T.Helper()
...
func (mr *MockFeatureFlagProcessorMockRecorder) IsReady() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsReady", reflect.TypeOf((*MockFeatureFlagProcessor)(nil).IsReady))
}
